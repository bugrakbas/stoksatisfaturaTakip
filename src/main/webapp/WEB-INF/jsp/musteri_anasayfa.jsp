...
<body style="width: 100%; height: 100%" background="https://miro.medium.com/max/1200/1*dP81IJq-tGFxy1rIK3RYsg.png">
...
<nav class="navbar navbar-inverse" style="background-color: black">
    <div class="container-fluid">
        ...
        <spring:url value="/satistemsilcisi_list" var="editUrl"/>
        <a class="btn btn-success" href="${editUrl}" role="button">Admin Ekleme</a>
    </div>
</nav>
